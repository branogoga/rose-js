...
describe("Storage", () => {
    describe(" InMemoryStorage", () => {
        it(" loads undefined before anything was stored in ", () => {
            const storage = new Data.Storage.InMemoryStorage();
        ...
        it(" does not share values with other storage ", () => {
            const storage1 = new Data.Storage.InMemoryStorage();
            storage1.setItem("key", 7);
            const item1 = storage1.getItem("key");
            expect(item1).toBe(7);
            const storage2 = new Data.Storage.InMemoryStorage();
            const item2 = storage2.getItem("key");
