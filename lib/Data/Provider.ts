...
export abstract class ProviderMockup<ItemType> implements ProviderInterface<ItemType> {
    ...
    private save(): void {
        this.storage.setItem(
            this.getStorageKey(),
            this.serializeItems(this.items)
            );
    }
    ...
    list(): Promise<Array<ItemType>> {
        return new Promise<Array<ItemType>>(
            function(
                ...
                console.log(uri);
                axios.get(uri)
                .then( function (response: AxiosResponse<Array<ItemType>>) {
    ...
    get(id: number): Promise<ItemType> {
        return new Promise<ItemType>(
            function(
                ...
                .then( function (response: AxiosResponse<ItemType>) {
                    console.log(response);
